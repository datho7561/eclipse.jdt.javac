...
public class JavacProblemConverter {
	...
	public int toProblemId(Diagnostic<? extends JavaFileObject> diagnostic) {
		...
		return switch (javacDiagnosticCode) {
			...
			case "compiler.err.undef.label" -> IProblem.UndefinedLabel;
			case "compiler.err.unexpected.lambda" -> IProblem.Syntax;
			case "compiler.err.deconstruction.pattern.only.records" -> IProblem.UnexpectedTypeinRecordPattern;
			case "compiler.err.use.of.underscore.not.allowed.non.variable" -> IProblem.UnderscoreCannotBeUsedHere;
			case "compiler.warn.preview.feature.use.plural", "compiler.warn.is.preview" -> IProblem.PreviewFeatureUsed;
